...
# Possible Commands
PUBLIC_COMMANDS = ['pairs.json', 'prices.json','coinnames.json'] 
...
class ccex:
    def __init__(self, APIKey='', Secret=''):
        ...
        self.float_roundPercent = lambda floatN, decimalP=2: str(round(float(floatN)*100, decimalP))+"%"
        	...
        	#PUBLIC COMMANDS
        self.pairs = lambda x=0: self.api('pairs.json')
        self.prices = lambda x=0: self.api('prices.json')
        self.coinnames = lambda x=0: self.api('coinnames.json')
